...
const MOEDAS: { value: Moeda; flag: string; label: string; desc: string }[] = [
  { value: 'BRL', flag: '🇧🇷', label: 'BRL', desc: 'Reais · Mercado Pago' },
  { value: 'EUR', flag: '🇵🇹', label: 'EUR', desc: 'Euros · Stripe' },
]

function detectMoeda(): Moeda {
  try {
    return navigator.language?.startsWith('pt-BR') ? 'BRL' : 'EUR'
  } catch {
    return 'EUR'
  }
}
...
export const CheckoutModal: React.FC<Props> = ({ open, onClose, cursoId, cursoTitulo }) => {
  ...
  const [moeda, setMoeda] = useState<Moeda>(detectMoeda)
    ...
    <>
      ...
      >
        ...
        <div style={{ marginBottom: '1.8rem' }}>
          <div style={{
            fontFamily: 'var(--fm)', fontSize: '.44rem', letterSpacing: '.18em',
          ...
          <p style={{ fontFamily: 'var(--fb)', fontSize: '.82rem', color: 'var(--ink-3)', lineHeight: 1.55 }}>
        ...
        <form onSubmit={handleSubmit} noValidate>
            ...
            <div style={{ display: 'flex', gap: '.5rem' }}>
              {MOEDAS.map(m => (
                ...
                >
                  ...
                  <div style={{
                    fontFamily: 'var(--fm)', fontSize: '.4rem', letterSpacing: '.08em',
            ...
            {!cupomAberto ? (
              <button
                ...
                style={{
                  ...
                  fontFamily: 'var(--fm)', fontSize: '.44rem', letterSpacing: '.1em',
          ...
          <button
            ...
            style={{
              ...
              fontFamily: 'var(--fm)', fontSize: '.5rem', letterSpacing: '.14em',
          ...
          <button
            ...
            style={{
              ...
              border: 'none', cursor: 'pointer', fontFamily: 'var(--fm)', fontSize: '.44rem',
