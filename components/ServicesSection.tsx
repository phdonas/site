...
const ServicesSection: React.FC = () => {
  ...
  return (
    <section className="py-24 px-6 bg-[#f5f5f7] border-y border-gray-200">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16 max-w-2xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 tracking-tight">{config.sections?.services?.title || "Como posso ajudar?"}</h2>
          <p className="text-gray-500 text-lg font-medium">{config.sections?.services?.subtitle || "Conheça nossas soluções para impulsionar seus resultados."}</p>
        </div>
