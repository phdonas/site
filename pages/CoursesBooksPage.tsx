    ...
    <main className="pt-24 min-h-screen bg-white">
      <div className="max-w-6xl mx-auto px-6 pb-20">
        <header className="py-20">
          <h1 className="text-6xl font-bold tracking-tight mb-4">{config.pages?.courses?.title || "Aprendizado & Literatura."}</h1>
          <p className="text-2xl text-gray-500 font-medium">{config.pages?.courses?.subtitle || "Explore nossos cursos exclusivos e obras publicadas."}</p>
        </header>

        {loading ? (
          <div className="py-20 text-center text-gray-400 font-medium">Carregando acervo...</div>
        ) : (
          <>
            {/* Courses Section */}
            {courses.length > 0 && (
                      ...
                      <div className="p-10 flex flex-col flex-1 justify-between">
                        ...
                        <div className="flex flex-col gap-3">
                          ...
                          {course.salesUrl && (
                            ...
                            >
                              Ir para Compra <ArrowUpRight size={20} />
                            </a>
                          )}
                        </div>
                      </div>
