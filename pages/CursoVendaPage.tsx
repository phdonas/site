          ...
          <ScrollReveal>
            ...
            {curso.objetivos && (
              <div style={{ fontSize: '1.5rem', color: 'rgba(243,239,230,.55)', lineHeight: 1.75, maxWidth: 560, marginBottom: '2rem' }}>
                {renderDescricao(curso.objetivos)}
              </div>
            )}

            <div style={{ display: 'flex', gap: '1.5rem', flexWrap: 'wrap', marginBottom: '2rem' }}>
              {curso.nivel && (
                <span style={{ display: 'flex', alignItems: 'center', gap: '.4rem', fontFamily: 'var(--fm)', fontSize: '.75rem', letterSpacing: '.1em', color: 'rgba(243,239,230,.4)' }}>
                  ◈ {curso.nivel}
                </span>
              )}
              {duracao && (
            ...
            <div style={{ maxWidth: 480, aspectRatio: '16/9', overflow: 'hidden', background: 'var(--navy)', border: '1px solid rgba(243,239,230,.08)' }}>
              {ytId ? (
                <iframe
                ...
                <div style={{ width: '100%', height: '100%', background: 'var(--navy)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <span style={{ fontFamily: 'var(--fm)', fontSize: '.75rem', letterSpacing: '.1em', color: 'rgba(243,239,230,.15)', textAlign: 'center', padding: '0 1rem' }}>
                    {curso.titulo}
                  </span>
                </div>
              )}
          ...
          <ScrollReveal delay={2}>
            <div style={{
              ...
              <div style={{ marginBottom: '1.2rem' }}>
                {isGratis ? (
                  <div style={{ fontFamily: 'var(--fd)', fontSize: '3rem', fontWeight: 700, color: '#27ae60' }}>Grátis</div>
                ) : preco ? (
                  <div>
                    {precoOriginal && precoOriginal > preco && (
                      <div style={{ fontFamily: 'var(--fm)', fontSize: '.9rem', color: 'var(--ink-3)', textDecoration: 'line-through', marginBottom: '.2rem' }}>
                        R$ {precoOriginal.toFixed(2).replace('.', ',')}
                      </div>
                    )}
                    <div style={{ fontFamily: 'var(--fd)', fontSize: '3rem', fontWeight: 700, color: 'var(--ink)' }}>
              ...
              {curso.garantia_dias && (
                <p style={{ fontFamily: 'var(--fm)', fontSize: '.75rem', letterSpacing: '.1em', color: 'var(--ink-3)', textAlign: 'center', marginTop: '.8rem' }}>
              ...
              {curso.inclui && curso.inclui.length > 0 && (
                <div style={{ marginTop: '1.5rem', borderTop: '1px solid var(--rule)', paddingTop: '1.2rem' }}>
                  <div style={{ fontFamily: 'var(--fm)', fontSize: '.75rem', letterSpacing: '.14em', textTransform: 'uppercase', color: 'var(--ink-3)', marginBottom: '.8rem' }}>
                    Inclui
                  </div>
        ...
        <div style={{ maxWidth: 520, margin: '0 auto', padding: '0 5vw' }}>
          <ScrollReveal>
            ...
            <div style={{ marginBottom: '2rem' }}>
              {isGratis ? (
                <span style={{ fontFamily: 'var(--fd)', fontSize: '3rem', fontWeight: 700, color: '#27ae60' }}>Grátis</span>
              ) : preco ? (
